...
public class ScientificWorkService {
    ...
    public ScientificWork findById(Long id) {
        return scientificWorkRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("Scientific Work Not Found. ID: " + id));
    }
    ...
    public ScientificWork patchScientificWorkById(Long id, ScientificWorkPatchDTO scientificWorkPatchDTO) {
        ...
        if (scientificWorkPatchDTO.studyProgramId() != null) {
            StudyProgram newStudyProgram = studyProgramService.getStudyProgramById(scientificWorkPatchDTO.studyProgramId());
